...
if(isset($_POST["btsubmit"])){
	...
	$email = $_POST['email'];
	$pwd = $_POST['pwd'];
    $select_user = "SELECT * FROM login WHERE email='$email' AND pwd='$pwd'";
    ...
    if($check_user == 1){
        ...
        $message = true;
        $mismatch = 'mismatch';
        header("location: login.php?mismatch=$mismatch");
    }
}
    ...
    <div class="main">
      <div class="container a-container" id="a-container">
        <form class="form" id="a-form" method="POST" action="login.php">
          ...
          <input class="form__input" type="password" name="pwd"placeholder="Password" required>
          <button class="lg" name="btsubmit" type="submit">LOG IN</button>
        </form>
      </div>
      ...
      <div class="switch" id="switch-cnt">
        ...
        <div class="switch__container is-hidden" id="switch-c2">
          ...
          <button class="switch__button button switch-btn"></button>
